  ...
  return (
    ...
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        <motion.div
          initial={{ opacity: 0.5, width: "18.75rem" }}
          whileInView={{ opacity: 1, width: "37.5rem" }}
          transition={{
            delay: 0.3,
            duration: 0.8,
            ease: "easeInOut",
          ...
          className="absolute inset-auto right-1/2 h-56 overflow-visible w-[37.5rem] bg-gradient-conic from-blue-400 via-transparent to-transparent text-white [--conic-position:from_70deg_at_center_top]"
        >
        ...
        <motion.div
          ...
          className="absolute inset-auto left-1/2 h-56 w-[37.5rem] bg-gradient-conic from-transparent via-transparent to-blue-400 text-white [--conic-position:from_290deg_at_center_top]"
        >
        ...
        <div className="absolute inset-auto z-50 h-36 w-[35rem] -translate-y-1/2 rounded-full bg-blue-400 opacity-50 blur-3xl"></div>
        <motion.div
          initial={{ width: "10rem" }}
        ...
        ></motion.div>
        <motion.div
          initial={{ width: "18.75rem" }}
          whileInView={{ width: "37.5rem" }}
          transition={{
            delay: 0.3,
            duration: 0.8,
            ease: "easeInOut",
          }}
          className="absolute inset-auto z-50 h-0.5 w-[37.5rem] -translate-y-[7rem] bg-blue-300 "
        ></motion.div>
